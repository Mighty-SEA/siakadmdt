...
export async function POST(req: Request) {
  try {
    ...
    await sendNotificationToAdmins(
      ...
      `Pengeluaran <b>${created.description}</b> sebesar <b>Rp${created.amount.toLocaleString('id-ID')}</b> berhasil ditambahkan ke sistem`,
      "success",
      req
    );
...
export async function PUT(req: Request) {
  ...
  try {
    ...
    await sendNotificationToAdmins(
      ...
      `Pengeluaran <b>${updated.description}</b> sebesar <b>Rp${updated.amount.toLocaleString('id-ID')}</b> berhasil diupdate`,
      "info",
      req
    );
...
export async function DELETE(req: Request) {
  ...
  try {
    if (id) {
      ...
      await sendNotificationToAdmins(
        "Pengeluaran Dihapus",
        `Pengeluaran <b>${deleted.description}</b> sebesar <b>Rp${deleted.amount.toLocaleString('id-ID')}</b> berhasil dihapus`,
        "warning",
        req
      );
