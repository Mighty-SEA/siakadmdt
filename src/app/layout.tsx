        ...
        <UIProvider>
          <div className="flex min-h-screen">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="dropdown dropdown-end">
                      <label tabIndex={0} className="btn btn-ghost btn-circle btn-sm">
                        <div className="w-5 h-5 rounded-full border-2 border-base-content flex items-center justify-center overflow-hidden" style={{ background: 'linear-gradient(135deg, var(--p) 0%, var(--s) 100%)' }}>
                          <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-base-content opacity-70">
                      ...
                      <div tabIndex={0} className="dropdown-content z-[100] shadow-lg bg-base-100 rounded-xl border border-base-300 w-72 p-3 dropdown-bottom dropdown-end">
                    ...
                    <div className="dropdown dropdown-end">
                      ...
                      <ul tabIndex={0} className="mt-3 shadow dropdown-content bg-base-100 rounded-xl overflow-hidden border border-base-300 w-56 transition-all duration-200 z-50">
                        ...
                        <div className="p-1">
                          <li>
                            <a className="flex items-center gap-2 p-2 text-sm hover:bg-primary/10 rounded-lg transition-all duration-200 text-base-content">
              ...
              <div className="drawer-side z-40">
                ...
                <aside className="menu p-4 w-64 min-h-full bg-base-200 text-base-content flex flex-col relative overflow-y-auto">
                  ...
                  <div className="mt-auto flex flex-col gap-2 pt-8 border-t border-base-300">
                    <button className="btn btn-ghost justify-start gap-3 text-base-content"><User className="w-5 h-5" />Profil</button>
                    <button className="btn btn-ghost justify-start gap-3 text-base-content" onClick={handleLogout}>Keluar</button>
                  </div>
                </aside>
              </div>
            </div>
            ...
            <aside className={`bg-base-200 text-base-content p-4 flex-col shadow-xl min-h-screen transition-[width] duration-300 ease-in-out hidden md:flex sticky top-0 h-screen ${sidebarOpen ? 'w-64' : 'w-20'}`} style={{transitionProperty: 'width'}}>
              ...
              <div className="mt-auto flex flex-col gap-2 pt-8 border-t border-base-300">
                <button className="btn btn-ghost justify-start gap-3 text-base-content"><User className="w-5 h-5" />{sidebarOpen && 'Profil'}</button>
                <button className="btn btn-ghost justify-start gap-3 text-base-content" onClick={handleLogout}>{sidebarOpen && 'Keluar'}</button>
              </div>
            </aside>
                ...
                <div className="flex items-center gap-4">
                  <div className="dropdown dropdown-end">
                    <label tabIndex={0} className="btn btn-ghost btn-circle">
                      <div className="w-6 h-6 rounded-full border-2 border-base-content flex items-center justify-center overflow-hidden" style={{ background: 'linear-gradient(135deg, var(--p) 0%, var(--s) 100%)' }}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-base-content opacity-70">
                          <circle cx="12" cy="12" r="5"></circle>
                          <path d="M12 1v2"></path>
                          <path d="M12 21v2"></path>
                    ...
                    <div tabIndex={0} className="dropdown-content z-[100] shadow-lg bg-base-100 rounded-xl border border-base-300 w-72 p-3">
                      <div className="flex items-center justify-between mb-3">
                        <h3 className="font-semibold text-base-content">Tema</h3>
                        <span className="badge badge-sm badge-primary">{theme}</span>
                      </div>
